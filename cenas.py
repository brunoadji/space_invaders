    ...
    def select(self, janela):
        ...
        if global_information.CoolDown:
            if global_information.Tempo >= global_information.TimeCoolDown:
                ...
                global_information.Tempo += janela.delta_time()
        ...
        if self.keyboard.key_pressed("D"):
            if self.nave.x < janela.width - self.nave.width:
                self.nave.x += global_information.Speed_x * janela.delta_time()
